		...
		<div class="container">
			...
			<div class="row justify-content-center">                
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Login to Exim Traders</h3>
                <form action="/logincust" class="login-form" method="post">
                    @csrf
                ...
                <center><p>Don't have account? Register <a href="/register">here</a></p></center>	
				{{-- <div class="form-group">
	            	<button type="submit" class="btn btn-primary rounded submit p-3 px-5">Get Started</button>
	            </div> --}}
	            <div class="form-group">
					<a href="/loginadmin"><button type="button" class="btn btn-primary rounded submit p-3">To Admin Login</button></a>
