    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="col-lg-12">
                ...
                <form class="form-horizontal style-form" method="POST" action="/admin/list/editadmin/new" enctype="multipart/form-data">
                    @csrf
                    @foreach ($data as $d)
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="user1" id="user1" value="{{$d->username_admin}}" hidden>
                                    <input type="text" class="form-control" name="user" id="user" value="{{$d->username_admin}}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="nama" id="nama" value="{{$d->nama_admin}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="telp" id="telp" value="{{$d->telp_admin}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="email" id="email" value="{{$d->email_admin}}" required>
                                </div>
                            </div>
                        </div>
